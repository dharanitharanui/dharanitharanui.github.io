(function(h) {
        "function" === typeof define && define.amd ? define(["jquery"], function(E) {
                ...
                E || (E = window);
                G || (G = "undefined" !== typeof window ? require("jquery") : require("jquery")
                        (E));
        ...
        function eb(a) {
                ...
                var b = a.aDataSort;
                "number" === typeof b && !h.isArray(b) && (a.aDataSort = [
                        b
                ])
        }
        ...
        function ja(a, b, c) {
                ...
                c !== k && null !== c && (eb(c), I(m.defaults.column, c), c.mDataProp !== k && !c.mData && (c.mData = c.mDataProp), c.sType && (b._sManualType = c.sType), c.className && !c.sClass && (c.sClass = c.className), c.sClass && e.addClass(c.sClass), h.extend(b, c), F(b, c, "sWidth", "sWidthOrig"), c.iDataSort !== k && (b.aDataSort = [
                        c.iDataSort
                ]), F(b, c, "aDataSort"));
                var g = b.mData,
                        j = Q(g),
        ...
        function B(a, b, c, d) {
                ...
                if (i === k) return a.iDrawError != e && null === j && (J(a, 0, "Requested unknown parameter " + ("function" == typeof f.mData ? "{function}" : "'" + f.mData + "'") + " for row " + b + ", column " + c, 4), a.iDrawError = e),
                        j;
                ...
                if ("string" === typeof a && (-1 !== a.indexOf(".") || -1 !== a.indexOf("[") || -1 !== a.indexOf("("))) {
                        var b = function(a, d, e) {
                                ...
                                for (var g,
                                        ...
                                        j && (e[i] = e[i].replace(U, ""), a = a[e[i]]
                                                (d));
                                        if (null === a[e[i]] || a[e[i]] === k) a[e[i]] = {};
                                        a = a[e[i]]
                                }
                                if (f.match(U)) a[f.replace(U, "")]
                                        (d);
        ...
        function Ha(a, b, c, d) {
                var e = [],
                        ...
                        t = function(a, b) {
                                if ("string" === typeof a) {
                                        var c = a.indexOf("@"); - 1 !== c && (c = a.substring(c + 1), R(a)
                                                (d, b.getAttribute(c)))
                                }
                        },
                        m = function(a) {
                                if (c === k || c === i) j = l[i],
                                        ...
                                        j && j._bAttrSrc ? (R(j.mData._)
                                                (d, n), t(j.mData.sort, a), t(j.mData.type, a), t(j.mData.filter, a)) : q ? (j._setter || (j._setter = R(j.mData)), j._setter(d, n)) : d[i] = n;
                                i++
                        };
                if (f)
                        for (; f;) {
        ...
        function Ga(a, b, c, d) {
                ...
                if (null === e.nTr) {
                        ...
                        for (q = a.aoColumns.length; l < q; l++) {
                                ...
                                g.push(i);
                                if (
                                        (!c || n.mRender || n.mData !== l) && (!h.isPlainObject(n.mData) || n.mData._ !== l + ".display")) i.innerHTML = B(a, b, l, "display");
                                n.sClass && (i.className += " " + n.sClass);
                                n.bVisible && !c ? j.appendChild(i) : !n.bVisible && c && i.parentNode.removeChild(i);
                                n.fnCreatedCell && n.fnCreatedCell.call(a.oInstance, i, B(a, b, l), f, b, l)
                        }
                        r(a, "aoRowCreatedCallback", null, [
                                j,
                                f,
                                b
                        ])
        ...
        function jb(a) {
                ...
                for (c = l.length; b < c; b++) f = l[b],
                        d = h(f.nTh).addClass(f.sClass), i && d.appendTo(e), a.oFeatures.bSort && (d.addClass(f.sSortingClass), !1 !== f.bSortable && (d.attr("tabindex", a.iTabIndex).attr("aria-controls", a.sTableId), La(a, f.nTh, b))), f.sTitle != d[0].innerHTML && d.html(f.sTitle), Ma(a, "header")(a, d, f, n);
                i && da(a.aoHeader, g);
                                ...
                                for (b = g[d].length; f < b; f++)
                                        if (n = i = 1, j[d]
                                                ...
                                                h(g[d]
                                                        [
                                                                f
                                                        ].cell).attr("rowspan", i).attr("colspan", n)
                                        }
                        }
                }
        }
        ...
        function N(a) {
                var b = r(a, "aoPreDrawCallback", "preDraw", [
                        a
                ]);
                ...
                for (var b = 0,
                        ...
                        for (var f = 0,
                                ...
                                if (c[b]
                                        [
                                                f
                                        ].unique && (!d[f] || !a.bSortCellsTop)) d[f] = c[b]
                                        [
                                                f
                                        ].cell;
                return d
        ...
        function sa(a, b, c) {
                r(a, "aoServerParams", "serverParams", [
                        b
                ]);
                if (b && h.isArray(b)) {
                        var d = {},
        ...
        function ta(a, b) {
                ...
                return "data" === c ? b.aaData || b[c] : "" !== c ? Q(c)
                        (b) : b
        }
        ...
        function xb(a) {
                for (var b = m.ext.search,
                        ...
                        for (var j = [],
                                        i = 0,
                                        n = c.length; i < n; i++) e = c[i],
                                d = a.aoData[e],
                                b[f]
                                (a, d._aFilterData, e, d._aData, i) && j.push(e);
                        c.length = 0;
                        h.merge(c, j)
                }
        }
        ...
        function wb(a, b, c, d, e, f) {
                if ("" !== b) {
                        for (var g = [],
                                        j = a.aiDisplay,
                                        d = Oa(b, d, e, f),
                                        e = 0; e < j.length; e++) b = a.aoData[j[e]]._aFilterData[c],
                                d.test(b) && g.push(j[e]);
                        a.aiDisplay = g
                }
        }
                ...
                for (f = a.aoData.length; d < f; d++)
                        if (h = a.aoData[d], !h._aFilterData) {
                                ...
                                for (g = b.length; e < g; e++) c = b[e],
                                        c.bSearchable ? (i = B(a, d, e, "filter"), l[c.sType] && (i = l[c.sType]
                                                (i)), null === i && (i = ""), "string" !== typeof i && i.toString && (i = i.toString())) : i = "",
        ...
        function ua(a, b) {
                ...
                r(a, null, "plugin-init", [
                        a,
                        b
                ]);
                r(a, "aoInitComplete", "init", [
                        a,
                        b
                ])
        }
        ...
        function nb(a) {
                for (var b = a.oClasses,
                                ...
                                g = 0,
                                j = f.length; g < j; g++) e[0][g] = new Option("number" === typeof d[g] ? a.fnFormatNumber(d[g]) : d[g], f[g]);
                        ...
                        fn: function(a) {
                                if (d) {
                                        var b = a._iDisplayStart,
                                                ...
                                                k,
                                                l = 0;
                                        for (k = f.p.length; l < k; l++) Ma(a, "pageButton")
                                                (a, f.p[l], l, h, b, i)
                                } else c.fnUpdate(a, e)
                        },
                        sName: "pagination"
        ...
        function Sa(a, b, c) {
                var d = a._iDisplayStart,
                        e = a._iDisplayLength,
                        f = a.fnRecordsDisplay();
                0 === f || -1 === e ? d = 0 : "number" === typeof b ? (d = b * e, d > f && (d = 0)) : "first" == b ? d = 0 : "previous" == b ? (d = 0 <= e ? d - e : 0, 0 > d && (d = 0)) : "next" == b ? d + e < f && (d += e) : "last" == b ? d = Math.floor(
                        (f - 1) / e) * e : J(a, 0, "Unknown paging action: " + b, 5);
        ...
        function Fb(a, b) {
                for (var c, d = -1,
                        ...
                        c = c.replace(Yb, ""), c = c.replace(/&nbsp;/g, " "), c.length > d && (d = c.length, e = f);
                return e
        }
        ...
        function V(a) {
                ...
                for (a = 0; a < n.length; a++) {
                        ...
                        for (c = f.length; b < c; b++) g = f[b],
                                j = e[g].sType || "string",
                                n[a]._idx === k && (n[a]._idx = h.inArray(n[a]
                                        [
                                                1
                                        ], e[g].asSorting)),
                                d.push({
        ...
        function Ua(a, b, c, d) {
                ...
                "number" === typeof e[0] && (e = a.aaSorting = [
                        e
                ]);
                c && a.oFeatures.bSortMulti ? (c = h.inArray(b, D(e, "0")), -1 !== c ? (b = g(e[c], !0), null === b && 1 === e.length && (b = 0), null === b ? e.splice(c, 1) : (e[c]
                        [
                                1
                        ] = f[b], e[c]._idx = b)) : (e.push(
                        [
                                b,
                                f[0],
                                0
                        ]), e[e.length - 1]._idx = 0)) : e.length && e[0][0] == b ? (b = g(e[0]), e.length = 1, e[0]
                        [
                                1
                        ] = f[b], e[0]._idx = b) : (e.length = 0, e.push(
                        [
                                b,
                                f[0]
                        ]), e[0]._idx = 0);
        ...
        function Gb(a, b) {
                ...
                for (var f, g = m.ext.type.order[c.sType + "-pre"],
                                j = 0,
                                i = a.aoData.length; j < i; j++)
        ...
        function xa(a) {
                if (a.oFeatures.bStateSave && !a.bDestroying) {
                        ...
                        r(a, "aoStateSaveParams", "stateSaveParams", [
                                a,
                                b
                        ]);
                        a.oSavedState = b;
        ...
        function J(a, b, c, d) {
                ...
                else if (b = m.ext, b = b.sErrMode || b.errMode, a && r(a, null, "error", [
                                a,
                                d,
                                c
                        ]), "alert" == b) alert(c);
        ...
        var m = function(a) {
                        ...
                        this.each(function() {
                                ...
                                if ("table" != this.nodeName.toLowerCase()) J(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
                                        ...
                                        g.aLengthMenu && !g.iDisplayLength && (g.iDisplayLength = h.isArray(g.aLengthMenu[0]) ? g.aLengthMenu[0]
                                                [
                                                        0
                                                ] : g.aLengthMenu[0]);
                                        g = Jb(h.extend(!0, {}, l), g);
                                        ...
                                        var T = p.oFeatures,
                                                e = function() {
                                                        if (g.aaSorting === k) {
                                                                var a = p.aaSorting;
                                                                j = 0;
                                                                for (i = a.length; j < i; j++) a[j]
                                                                        [
                                                                                1
                                                                        ] = p.aoColumns[j].asSorting[0]
                                                        }
                                                        wa(p);
                ...
                Qb = function(a) {
                        for (var b = [],
                                        c = 0,
                                        d = a.length; c < d; c++) a[c] && b.push(a[c]);
                        return b
                },
                qa = function(a) {
                        var b;
        ...
        var A = function(a, b, c) {
                ...
                ac = function(a) {
                        ...
                        if (a) {
                                if (a.nTable && a.oApi) return [
                                        a
                                ];
                                if (a.nodeName && "table" === a.nodeName.toLowerCase()) return b = h.inArray(a, e), -1 !== b ? [
                                        d[b]
                                ] : null;
        ...
        h.extend(s.prototype, {
                ...
                iterator: function(a, b, c, d) {
                        ...
                        for (j = l.length; g < j; g++) {
                                var r = new s(l[g]);
                                if ("table" === b) f = c.call(r, l[g], g),
                                        f !== k && e.push(f);
                                else if ("columns" === b || "rows" === b) f = c.call(r, l[g], this[g], g),
                                        f !== k && e.push(f);
                                else if ("column" === b || "column-rows" === b || "row" === b || "cell" === b) {
                                        o = this[g];
                                        "column-rows" === b && (m = Ba(l[g], u.opts));
                                        h = 0;
                                        for (n = o.length; h < n; h++) f = o[h],
                                                f = "cell" === b ? c.call(r, l[g], f.row, f.column, g, h) : c.call(r, l[g], f, g, h, m),
                                                f !== k && e.push(f)
                                }
                        }
                        return e.length || d ? (a = new s(l, a ? e.concat.apply(
                                [], e) : e), b = a.selector, b.rows = u.rows, b.cols = u.cols, b.opts = u.opts, a) : this
                },
        ...
        s.register = o = function(a, b) {
                if (h.isArray(a))
                        for (var c = 0,
                                        d = a.length; c < d; c++) s.register(a[c], b);
                else
                        for (var e = a.split("."),
                                        f = Rb,
                                        g,
        ...
        var Za = function(a, b, c, d, e) {
                        var f = [],
                                ...
                                m;
                        i = typeof b;
                        if (!b || "string" === i || "function" === i || b.length === k) b = [
                                b
                        ];
                        i = 0;
                ...
                ab = function(a) {
                        for (var b = 0,
                                        c = a.length; b < c; b++)
                                if (0 < a[b].length) return a[0] = a[b],
                                        a[0].length = 1,
                                        a.length = 1,
                                        a.context = [
                                                a.context[b]
        ...
        u("rows().ids()", "row().id()", function(a) {
                for (var b = [],
                        ...
                        for (var f = 0,
                                ...
                                var h = c[d].rowIdFn(c[d].aoData[this[d]
                                        [
                                                f
                                        ]]._aData);
                                b.push(
        ...
        var bc = /^([^:]+):(name|visIdx|visible)$/,
                Ub = function(a, b, c, d, e) {
                        for (var c = [],
                                        d = 0,
                                        f = e.length; d < f; d++) c.push(B(a, e[d], b));
                        return c
                };
                ...
                var b = $a(b),
                        c = this.iterator("table", function(c) {
                                ...
                                return Za("column", e, function(a) {
                                        ...
                                        if (a.nodeName && a._DT_CellIndex) return [
        ...
        o("$()", function(a, b) {
                var c = this.rows(b).nodes(),
                        c = h(c);
                return h(
                        [].concat(c.filter(a).toArray(), c.find(a).toArray()))
        });
        ...
        h.each(["column", "row", "cell"], function(a, b) {
                o(b + "s().every()", function(a) {
                        ...
                        return this.iterator(b, function(f, g, h, i, n) {
                                a.call(e[b]
                                        (g, "cell" === b ? h : d, "cell" === b ? d : k), g, h, i, n)
                        })
                })
        });
        ...
        m.defaults = {
                ...
                fnStateLoadCallback: function(a) {
                        try {
                                return JSON.parse(
                                        (-1 === a.iStateDuration ? sessionStorage : localStorage).getItem("DataTables_" + a.sInstance + "_" + location.pathname))
                        } catch (b) {}
                },
